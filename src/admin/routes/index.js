...
router.put(
  ...
  isAdmin,
  usuarioValidator.cambiarPassword,
...
router.post(
  ...
  mediaController.subirMultiple
);
router.get(
  "/media/producto/:producto_id",
  isAdmin,
  mediaController.obtenerPorProducto
);
router.put("/media/orden", isAdmin, mediaController.actualizarOrden);
router.put("/media/principal", isAdmin, mediaController.setPrincipal);
